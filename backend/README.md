...
## Project Structure
    ...
    ├── storestacks_marketp_33358  # Django project configurations
...
1. Clone this repo and `cd storestacks_marketp_33358`
...
2. Clone this repo and `cd storestacks_marketp_33358`
